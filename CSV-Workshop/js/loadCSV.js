...
function changeData(){
  ...
  for (let i = 0; i< table.getRowCount (); i++){
    if(companyMenu.option == table.getString(i, 'company')){
      text(table.getString(i, 'company'), windowWidth/2, 50)
      text(table.getString(i, 'date'), windowWidth/2, 50)
      text(table.getString(i, 'location'), windowWidth/2, 50)
      text(table.getString(i, 'service'), windowWidth/2, 50)
      text(table.getString(i, 'frequency'), windowWidth/2, 50)
